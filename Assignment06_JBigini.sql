...
-- 2026-05-26,JBigini,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_JBigini')
	 Begin 
	  Alter Database [Assignment06DB_JBigini] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_JBigini;
	 End
	Create Database Assignment06DB_JBigini;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_JBigini;
